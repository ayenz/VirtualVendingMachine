...
//        final String[] labels = loadLabels("labels/mscoco_label_map.pbtxt");
//        try (SavedModelBundle model = SavedModelBundle.load("models/ssd_inception_v2_coco_2017_11_17/saved_model", "serve")) {
//            printSignature(model);
//            final String filename = "images/peron.jpg";
...
//    }
    ...
    public void getDetectedObject(String image) throws Exception{
        final String[] labels = loadLabels("labels/mscoco_label_map.pbtxt");
        try (SavedModelBundle model = SavedModelBundle.load("models/ssd_inception_v2_coco_2017_11_17/saved_model", "serve")) {
            printSignature(model);
